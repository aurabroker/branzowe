...
<main class="wrap">
	<div class="done">
		<div class="ic">✓</div>
		<h2>Wniosek przyjęty</h2>
		<p>
			Numer <b>{nr}</b>. Kopia oferty poszła na <b>{email}</b>. Opiekun odezwie się w ciągu jednego
			dnia roboczego.
		</p>

		{#if kompletny}
			<div class="komplet">
				<strong>Wniosek jest kompletny.</strong>
				<small>
					Strukturę wiekową już mamy — nie musisz nic odsyłać. Opiekun potwierdzi warunki i
					przygotuje polisę.
				</small>
			</div>
		{:else}
			<div class="xls">
				<div class="ix">XLS</div>
				<div>
		...
		{#if promo}
			<a class="promo" href="https://utratadochodu.pl/?utm_source=partner&utm_medium=display&utm_campaign=permanentlink&utm_content=ergobranzowe&utm_term=wniosek" target="_blank" rel="noopener">
				<img src={promo} alt="" />
			</a>
		{/if}
